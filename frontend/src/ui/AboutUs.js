  ...
  return (
    <>
      ...
      <container classname={"auBox"}>
        ...
        <h4>We are a group of students learning frontend and backend web development as apart of Deep Dive Coding's Fullstack Web Development bootcamp, based out of Albuquerque, New Mexico. We worked from across New Mexico and Texas to plan, design, code, and implement Squad Finder for our Capstone project. Squad Finder was created with the intention to connect players within the e-sports gaming community for team/squad formations. </h4>
